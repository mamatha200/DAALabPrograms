...
{
int i,j,k,ccost;//In the provided code, ccost is a local variable used to temporarily store the cost returned by the recursive call to the tsp method.
                     //It represents the cost of the tour calculated for a specific permutation of cities.
